...
Konsep penting lainnya adalah Beacon Frame, yaitu paket yang dikirim secara berkala oleh AP kepada perangkat untuk mengkonfirmasi keberadaan dan status koneksi jaringan. Pada Wireshark, beacon frame dapat disaring menggunakan filter wlan.fc.type_subtype == 8, dan dari hasil analisis terlihat bahwa beacon frame dikirimkan dengan interval setiap 8 milidetik. Untuk keperluan praktikum, analisis dilakukan menggunakan berkas Wireshark_802_11.pcap yang diunduh dari tautan resmi laboratorium.
